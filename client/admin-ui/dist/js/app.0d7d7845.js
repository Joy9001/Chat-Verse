(function (e) {
    function t(t) {
        for (
            var a, r, i = t[0], c = t[1], l = t[2], u = 0, m = [];
            u < i.length;
            u++
        )
            (r = i[u]),
    ...
    "56d7": function (e, t, n) {
            ...
            i = function () {
                ...
                return n(
                    ...
                    [
                        ...
                        n("v-toolbar-title", { staticClass: "ml-3" }, [
                            e._v("Socket.IO Admin UI"),
                        ]),
                        n(
                            "v-btn",
                            {
                ...
                return n(
                    "v-navigation-drawer",
                    {
                        ...
                        model: {
                            ...
                            callback: function (t) {
                                e.$set(
                                    e.$store.state.config,
                                    "showNavigationDrawer",
                                    t,
                                );
                            },
                            expression:
                                "$store.state.config.showNavigationDrawer",
                        },
                    },
                    [
                        n(
        ...
        var ee = function () {
            ...
            ne = {
                ...
                methods: Object(r["a"])(
                    {},
                    Object(l["c"])("config", ["toggleReadonly"]),
                ),
            },
            ae = ne,
        ...
        var re = {
                ...
                computed: Object(r["a"])(
                    Object(r["a"])(
                        {},
                        Object(l["b"])("config", ["developmentMode"]),
                    ),
                    {},
                    {
                        items: function () {
                ...
                return n(
                    ...
                    [
                        n(
                            ...
                            [
                                n("v-card-title", [
                                    e._v(e._s(e.$t("connection.title"))),
                                ]),
                                n("v-card-text", [
                                    n(
                                        "form",
        ...
        var Ee = {
                ...
                watch: {
                    $route: function (e, t) {
                        e.meta.topLevel && t.meta.topLevel
                            ? (this.transitionName =
                                  e.meta.index > t.meta.index
                                      ? "v-slide-y-reverse-transition"
                                      : "v-slide-y-transition")
                            : (this.transitionName = e.meta.topLevel
                ...
                methods: {
                    tryConnect: function (e, t, n, a, s, o) {
                        ...
                        (this.isConnecting = !0),
                            Te.socket &&
                                (Te.socket.disconnect(),
                                Te.socket.off("connect"),
                                Te.socket.off("connect_error"),
                                Te.socket.off("disconnect"));
                        ...
                        i.once("connect", function () {
                            ...
                            i.on("connect_error", function (e) {
                                (r.isConnecting ||
                                    ...
                                    ((r.showConnectionModal = !0),
                                    (r.connectionError = e.message)),
                                    (r.isConnecting = !1);
                            }),
                            i.on("disconnect", function (e) {
                                r.isConnecting &&
                                    ((r.isConnecting = !1),
                                    (r.connectionError = e)),
                                    r.$store.commit("connection/disconnect");
                            });
                    },
                    registerEventListeners: function (e) {
                        ...
                        e.on("session", function (e) {
                            ...
                            e.on("server_stats", function (e) {
                                t.$store.commit("servers/onServerStats", e),
                                    t.$store.commit("main/onServerStats", e);
                            }),
                ...
                created: function () {
                    if (
                        ((this.$vuetify.theme.dark =
                            this.$store.state.config.darkTheme),
                    ...
                    {},
                    {
                        clientsCount: function () {
                            return this.hasAggregatedValues
                                ? Object(rt["a"])(this.servers, "clientsCount")
                                : this.clients.length;
                        },
                                ...
                                datasets: [
                                    {
                                        ...
                                        borderColor: this.darkTheme
                                            ? "black"
                                            : "white",
                                        data: [
                                            this.transportRepartition[
                                                "websocket"
                                            ],
                                            this.transportRepartition[
                                                "polling"
        ...
        var pt = function () {
                ...
                computed: Object(r["a"])(
                    ...
                    {},
                    {
                        data: function () {
                            return {
                                labels: [
                                    this.$t("servers.healthy"),
                                    this.$t("servers.unhealthy"),
                                ],
                                datasets: [
                                    {
                                        backgroundColor: [
            ...
            Ot =
                (n("a86e"),
                Object(b["a"])(St, pt, vt, !1, null, "0ad5cc14", null)),
            Ct = Ot.exports;
        k()(Ot, {
            VBtn: I["a"],
            VCard: Ce["a"],
        ...
        var It = function () {
                ...
                return n(
                    "v-card",
                    [
                        n("v-card-title", { staticClass: "text-center" }, [
                            e._v(
                                " " +
                                    e._s(
                                        e.$t(
                                            "dashboard.connectionsHistogram.title",
                                        ),
                                    ) +
                                    " ",
                            ),
        ...
        var Pt = {
                ...
                computed: Object(r["a"])(
                    Object(r["a"])(
                        {},
                        Object(l["d"])("main", ["aggregatedEvents"]),
                    ),
                    {},
                    {
                ...
                methods: {
                    updateChartBounds: function () {
                        var e = new Date();
                        (this.chartOptions.scales.x.min = Object(Nt["a"])(
                            e,
                            10,
                        )),
                            (this.chartOptions.scales.x.max = e);
                    },
                },
            },
            Bt = Pt,
                    ...
                    [
                        n("v-card-title", { staticClass: "text-center" }, [
                            e._v(
                                " " +
                                    e._s(
                                        e.$t("dashboard.bytesHistogram.title"),
                                    ) +
                                    " ",
                            ),
                        ]),
                        ...
                        chartData: function () {
                            return {
                                datasets: [
                                    {
                                        label: this.$i18n.t(
                                            "dashboard.bytesHistogram.bytesIn",
                                        ),
                                        backgroundColor: v["a"].green.base,
                                        data: this.bytesIn,
                                    },
                                    {
                                        label: this.$i18n.t(
                                            "dashboard.bytesHistogram.bytesOut",
                                        ),
                                        backgroundColor: v["a"].red.base,
                                        data: this.bytesOut,
                                    },
        ...
        var Xt = function () {
            ...
            an = {
                ...
                methods: Object(r["a"])(
                    {},
                    Object(l["c"])("main", ["selectNamespace"]),
                ),
            },
            sn = an,
            on =
                (n("f712"),
                Object(b["a"])(sn, tn, nn, !1, null, "2c330798", null)),
            rn = on.exports;
        k()(on, { VSelect: F["a"] });
        var cn = {
                name: "Sockets",
                ...
                computed: Object(r["a"])(
                    ...
                    Object(l["d"])({
                        ...
                        isSocketDisconnectSupported: function (e) {
                            return e.config.supportedFeatures.includes(
                                "DISCONNECT",
                            );
                        },
                    }),
                        ...
                        n("v-card-text", [
                            n(
                                ...
                                [
                                    n("v-combobox", {
                                        staticClass:
                                            "select-room d-inline-block mr-3",
                                        attrs: {
        ...
        var Cn = function () {
                ...
                return n(
                    ...
                    [
                        ...
                        n("v-card-text", [
                            n("h4", [e._v(e._s(e.$t("sockets.client")))]),
                        ]),
                        n(
                            "v-simple-table",
                            { attrs: { dense: "" } },
                        ...
                        n("v-card-text", [
                            n("h4", [e._v(e._s(e.$t("sockets.socket")))]),
                        ]),
                        n("v-simple-table", {
                            attrs: { dense: "" },
                            scopedSlots: e._u([
            ...
            wn =
                (n("eb02"),
                Object(b["a"])(jn, Cn, xn, !1, null, "3c0dcfcd", null)),
            Vn = wn.exports;
        k()(wn, {
            VBtn: I["a"],
            VCard: Ce["a"],
        ...
        var Dn = function () {
                ...
                return n(
                    ...
                    [
                        n("v-card-title", [
                            e._v(e._s(e.$t("sockets.initial-request"))),
                        ]),
                        n("v-card-text", [
                            n("h4", [e._v(e._s(e.$t("sockets.headers")))]),
                        ]),
                        n("KeyValueTable", {
                            attrs: { object: e.socket.handshake.headers },
                        }),
                        n("v-card-text", [
                            n("h4", [e._v(e._s(e.$t("sockets.query-params")))]),
                        ]),
                        n("KeyValueTable", {
            ...
            Pn =
                (n("786c"),
                Object(b["a"])(Rn, In, En, !1, null, "18284f59", null)),
            Bn = Pn.exports;
        ...
        var Hn = {
                ...
                mounted: function () {
                    (this.socket = this.findSocketById(
                        ...
                        this.socket &&
                            (this.client = this.findClientById(
        ...
        var Jn = function () {
            ...
            na =
                (n("3a99"),
                Object(b["a"])(ta, Jn, Gn, !1, null, "29992f63", null)),
            aa = na.exports;
        k()(na, {
            VBreadcrumbs: Wt["a"],
            VBtn: I["a"],
        ...
        var sa = function () {
            ...
            ca =
                (n("ff8e"),
                Object(b["a"])(ia, sa, oa, !1, null, "57b53591", null)),
            la = ca.exports;
        k()(ca, {
            VBreadcrumbs: Wt["a"],
            VBtn: I["a"],
        ...
        var da = function () {
            ...
            ha =
                (n("6602"),
                Object(b["a"])(fa, ma, pa, !1, null, "8d2424e4", null)),
            ba = ha.exports;
        k()(ha, {
            VBtn: I["a"],
            VCard: Ce["a"],
        ...
        var ga = function () {
            ...
            Sa =
                (n("1993"),
                Object(b["a"])(ya, ga, ka, !1, null, "38772079", null)),
            Oa = Sa.exports;
        k()(Sa, {
            VBtn: I["a"],
            VCard: Ce["a"],
        ...
        var Ca = {
                ...
                mounted: function () {
                    (this.client = this.findClientById(this.$route.params.id)),
                        this.client && (this.socket = this.client.sockets[0]);
                },
            },
            xa = Ca,
        ...
        var Na = function () {
            ...
            La =
                (n("6e0b"),
                Object(b["a"])(Ua, Pa, Ba, !1, null, "c9425064", null)),
            Ma = La.exports;
        k()(La, {
            VBtn: I["a"],
            VCard: Ce["a"],
        ...
        var ss = function () {
            ...
            rs = function () {
                ...
                return n(
                    "v-chip",
                    { attrs: { color: e.color, outlined: "" } },
                    [e._v(" " + e._s(e.$t("events.type." + e.type)) + " ")],
                );
            },
            is = [],
            cs = {
        ...
        var ms = {
                ...
                methods: {
                    ...
                    isExpandable: function (e) {
                        return ["event_received", "event_sent"].includes(
                            e.type,
                        );
                    },
                },
            ...
            vs =
                (n("76e7"),
                Object(b["a"])(ps, ss, os, !1, null, "2c2337d4", null)),
            fs = vs.exports;
        k()(vs, {
            VBreadcrumbs: Wt["a"],
            VBtn: I["a"],
        ...
        var ys = new ks["a"]({
            ...
            Ss = {
                ...
                getters: {
                    developmentMode: function (e) {
                        return (
                            e.supportedFeatures.includes("ALL_EVENTS") ||
                            !e.supportedFeatures.includes("AGGREGATED_EVENTS")
                        );
                    },
                    hasAggregatedValues: function (e) {
                        return e.supportedFeatures.includes(
                            "AGGREGATED_EVENTS",
                        );
                    },
                },
                mutations: {
                    init: function (e) {
                        tt &&
                            ((e.darkTheme =
                                "true" === localStorage.getItem("dark_theme")),
                            (e.readonly =
                                "true" === localStorage.getItem("readonly")),
                            (e.lang = localStorage.getItem("lang") || "en"));
                    },
                    selectTheme: function (e, t) {
                        (e.darkTheme = t),
                            tt && localStorage.setItem("dark_theme", t);
                    },
                    ...
                    toggleReadonly: function (e) {
                        (e.readonly = !e.readonly),
                            tt && localStorage.setItem("readonly", e.readonly);
                    },
                ...
                (n("8a79"),
                {
                    ...
                    mutations: {
                            ...
                            tt &&
                                ...
                                e.serverUrl.endsWith("/admin")
                                    ...
                                    : (e.namespace =
                                          ...
                                          "/admin"),
                                (e.wsOnly =
                                    "true" === localStorage.getItem("ws_only")),
                                (e.sessionId =
                        ...
                        saveSessionId: function (e, t) {
                            (e.sessionId = t),
                                tt && localStorage.setItem("session_id", t);
                        },
                        connect: function (e) {
                            e.connected = !0;
                        },
            ...
            Is = function (e, t) {
                ...
                return (
                    n ||
                    ((n = { id: t, connected: !0, sockets: [] }), e.push(n), n)
                );
            },
            Es = function (e, t) {
                var n = Ds(e.namespaces, t.nsp);
                (t.connected = !0),
                    Object($s["a"])(n.sockets, { id: t.id }) ||
                        n.sockets.push(t),
        ...
        var As = {
                ...
                getters: {
                    ...
                    sockets: function (e) {
                        return e.selectedNamespace
                            ? e.selectedNamespace.sockets
                            : [];
                    },
                    rooms: function (e) {
                        return e.selectedNamespace
                            ? e.selectedNamespace.rooms
                            : [];
                    },
                    events: function (e) {
                        return e.selectedNamespace
                            ? e.selectedNamespace.events
                            : [];
                    },
                },
                mutations: {
