								...
								fn: function () {
									return [
										...
										n(
											...
											[n('LangSelector'), n('ThemeSelector'), n('ReadonlyToggle')],
											1
										),
									]
								},
					...
					tryConnect: function (e, t, n, a, s, o) {
						...
						i.once('connect', function () {
							...
							i.on('disconnect', function (e) {
								r.isConnecting && ((r.isConnecting = !1), (r.connectionError = e)),
				...
				return n(
					...
					[
						n('v-card-title', { staticClass: 'text-center' }, [
							e._v(' ' + e._s(e.$t('dashboard.connectionsHistogram.title')) + ' '),
						]),
						n(
							'v-card-text',
							[
											...
											n('tbody', [
												...
												n('tr', [
													...
													n('td', [
														n('pre', [
															n('code', [
																e._v(e._s(JSON.stringify(e.socket.data, null, 2))),
															]),
														]),
													]),
													n('td'),
									...
									scopedSlots: e._u([
										{
											...
											fn: function (t) {
												...
												return [
													a.sockets.length
														? n('span', [e._v(e._s(a.sockets[0].handshake.address))])
														: e._e(),
												]
											},
										},
				...
				mutations: {
					...
					onSocketDisconnected: function (e, t) {
						...
						if (l) {
							...
							at(d.sockets, { id: s }),
								0 === d.sockets.length && ((d.connected = !1), at(e.clients, { id: l.clientId }))
						}
						Ps(r.events, {
							type: 'disconnection',
							timestamp: n,
