(function (e) {
  ...
  "56d7": function (e, t, n) {
                    ...
                    n(
                      ...
                      [
                        n("div", { staticClass: "mt-3" }, [
                          e._v(
                            " " +
                              e._s(e.$t("connection.serverUrl")) +
                              e._s(e.$t("separator")),
                          ),
                          e.serverUrl
                            ? n("code", [e._v(e._s(e.serverUrl))])
                            : e._e(),
                        ]),
                        n(
                          "div",
              ...
              [
                n("div", [
                  ...
                  n(
                    ...
                    [
                      e._v(
                        " " + e._s(e.$t("status")) + e._s(e.$t("separator")),
                      ),
                      n("ConnectionStatus", {
                        attrs: {
                          connected: e.connected,
          ...
          tryConnect: function (e, t, n, a, s, o) {
            ...
            i.once("connect", function () {
              ...
              i.on("disconnect", function (e) {
                r.isConnecting &&
                  ((r.isConnecting = !1), (r.connectionError = e)),
                            ...
                            return [
                              n(
                                ...
                                [
                                  n("tr", [
                                    n("th", [
                                      e._v(e._s(e.$t("sockets.transport"))),
                                    ]),
                                    n("th", [e._v("#")]),
                                  ]),
    ...
    function at(e, t) {
      var n =
        "object" === Object(Qe["a"])(t) ? Object(Xe["a"])(e, t) : e.indexOf(t);
                            ...
                            return [
                              n("tbody", [
                                ...
                                n("tr", [
                                  ...
                                  n("td", [
                                    n("div", [
                                      n("h2", [e._v(e._s(e.healthyServers))]),
                                    ]),
                                    n("div", [
                                      e._v(
                                        e._s(
                    ...
                    return [
                      n("thead", [
                        n("tr", [
                          ...
                          n("th", [e._v(e._s(e.$t("rooms.sockets-count")))]),
                        ]),
                      ]),
                      n(
                        "tbody",
              ...
              Object(r["a"])(
                ...
                Object(l["d"])({
                  plainNamespaces: function (e) {
                    return Object(jt["a"])(e.main.namespaces, "name").map(
                      function (e) {
                        var t = e.name,
                          n = e.sockets;
                        return {
        ...
        return n(
          ...
          [
            n("v-card-title", { staticClass: "text-center" }, [
              e._v(
                " " + e._s(e.$t("dashboard.connectionsHistogram.title")) + " ",
              ),
            ]),
            n(
              "v-card-text",
    ...
    var Pt = {
        ...
        created: function () {
          this.updateChartBounds(),
            (this.interval = setInterval(this.updateChartBounds, 1e4));
        },
        ...
        methods: {
          updateChartBounds: function () {
            var e = new Date();
            (this.chartOptions.scales.x.min = Object(Nt["a"])(e, 10)),
    ...
    var Lt = function () {
        ...
        return n(
          ...
          [
            n("v-card-title", { staticClass: "text-center" }, [
              e._v(" " + e._s(e.$t("dashboard.bytesHistogram.title")) + " "),
            ]),
            n(
              "v-card-text",
              [
                        ...
                        return [
                          e.isSocketDisconnectSupported
                            ? n(
                                ...
                                [
                                  n("span", [
                                    e._v(e._s(e.$t("sockets.disconnect"))),
                                  ]),
                                ],
                              )
                            : e._e(),
                        ...
                        [
                          e.isSocketDisconnectSupported && e.client.connected
                            ? n(
                                ...
                                [
                                  n("span", [
                                    e._v(e._s(e.$t("clients.disconnect"))),
                                  ]),
                                ],
                              )
                            : e._e(),
                        ...
                        n("tr", [
                          ...
                          n("td", [
                            n("pre", [
                              n("code", [
                                e._v(
                                  e._s(JSON.stringify(e.socket.data, null, 2)),
                                ),
                              ]),
                            ]),
                          ]),
                        ...
                        return [
                          ...
                          e.isMultiDisconnectSupported
                            ? n(
                                ...
                                [
                                  n("span", [
                                    e._v(e._s(e.$t("rooms.disconnect"))),
                                  ]),
                                ],
                              )
                            : e._e(),
                  ...
                  scopedSlots: e._u([
                    {
                      ...
                      fn: function (t) {
                        ...
                        return [
                          a.sockets.length
                            ? n("span", [
                                e._v(e._s(a.sockets[0].handshake.address)),
                              ])
                            : e._e(),
                        ];
                      },
                  ...
                  scopedSlots: e._u([
                    ...
                    },
                    {
                      ...
                      fn: function (t) {
                        var n = t.value;
                        return [
                          e._v(" " + e._s(e.delaySinceLastPing(n)) + " "),
                        ];
                      },
                    },
                    {
    ...
    var ss = function () {
      ...
      rs = function () {
        var e = this,
          t = e.$createElement,
          n = e._self._c || t;
        return n("v-chip", { attrs: { color: e.color, outlined: "" } }, [
    ...
    var ys = new ks["a"]({
            ...
            init: function (e) {
              tt &&
                ...
                e.serverUrl.endsWith("/admin")
                  ...
                  : (e.namespace =
                      localStorage.getItem("namespace") || "/admin"),
      ...
      Ds = function (e, t) {
        ...
        return (
          n ||
          ((n = { name: t, sockets: [], rooms: [], events: [] }), e.push(n), n)
        );
      },
      Ts = function (e, t) {
        var n = Object($s["a"])(e.rooms, { name: t });
        return (
          n || ((n = { name: t, active: !0, sockets: [] }), e.rooms.push(n), n)
        );
      },
      Is = function (e, t) {
        ...
        mutations: {
          ...
          onSocketDisconnected: function (e, t) {
            ...
            if (l) {
              ...
              at(d.sockets, { id: s }),
                0 === d.sockets.length &&
                  ((d.connected = !1), at(e.clients, { id: l.clientId }));
            }
            Ps(r.events, {
              type: "disconnection",
              timestamp: n,
