...
/*!********************************************!*\
  !*** ./client/scripts/components/login.js ***!
  \********************************************/
...
document.querySelector('#login-btn').addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var email, password, alert, response, data;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 23:
        ...
        document.querySelector('#login-alert span').textContent = _context.t0.message;
        document.querySelector('#login-alert').classList.remove('hidden');
        setTimeout(function () {
          document.querySelector('#login-alert').classList.add('hidden');
        }, 3000);
