...
export const groupChatClicked = (htmlElement, ...args) => {
  ...
  if (args[0] && args[0].groupId === clickedGroupId) {
    ...
    clickedGroup = {
      ...
      groupDescription:
        htmlElement.querySelector(".group-description").innerText,
...
export const handleGroupChat = (clickedGroup) => {
  ...
  let _groupDescription = document.querySelector(
  ...
  if (groupMessages.length === 0) {
    ...
    groupMessages.forEach((msg) => {
      ...
      if (msg.senderId === requesterId) {
        let fromUserGroupMsg = fromUserGroupMsgComponent(
          msg.message,
          msg._id,
          msgTime,
          msg.senderName,
        ...
        let toUserGroupMsg = toUserGroupMsgComponent(
          msg.message,
          msg._id,
          msgTime,
          msg.senderName,
